  ...
  def main(args: Array[String]): Unit = {
    ...
    val watermark = inputMap.assignTimestampsAndWatermarks(new AssignerWithPeriodicWatermarks[(String, Long)] {
      ...
      override def getCurrentWatermark: Watermark = {
        ...
        //        println("currentMaxTimestamp = " + currentMaxTimestamp)
        a = new Watermark(currentMaxTimestamp - maxOutOfOrderness)
        println("getCurrentWatermark = " + a)
        a
      }
      ...
      override def extractTimestamp(t: (String, Long), l: Long): Long = {
        ...
        println("timestamp:" + t._1 + "," + t._2 + "|" + format.format(t._2) + "," + currentMaxTimestamp + "|" + format.format(currentMaxTimestamp) + "," + a)
        timestamp
      }
    })
